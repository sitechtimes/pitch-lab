  ...
  <div class="flex flex-row items-center">
    <div class="flex flex-col items-center w-[30%]">
      ...
      >
        ...
        ></span>
        <span
          class="absolute w-36 h-32 -top-8 -left-2 bg-dark-purple rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-left"
        ></span>
        <span
          class="absolute w-36 h-32 -top-8 -left-2 bg-blue rotate-12 transform scale-x-0 group-hover:scale-x-50 transition-transform group-hover:duration-1000 duration-500 origin-left"
        ></span>
