<template>
  <div
    :class="[
      ...
      'justify-center',
      'p-4',
      { fullscreen: isTunerFullScreen },
    ]"
  >
    <!-- Expand Button -->
    <button
      class="bg-blue-500 text-white font-bold py-2 px-4 rounded absolute top-4 right-4 z-10"
      @click="toggleTunerFullScreen"
    >
      {{ isTunerFullScreen ? "Exit Full Screen" : "Expand to Full Screen" }}
    </button>
